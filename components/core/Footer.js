...
const Footer = () => {
  return (
    <div className=' flex justify-center flex-col items-center border-t-[1px] border-t-slate-200 mt-2 ' >
        <div className=' flex justify-center items-center ' >
            <ul className=' flex gap-4 md:gap-8  lg:gap-10 py-4 text-lg lg:text-2xl text-gray-900 ' >
